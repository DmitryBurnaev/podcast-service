...
def upgrade():
    ...
    op.add_column('auth_user_ips', sa.Column('registered_by', sa.String(length=128), nullable=False, server_default=""))
    op.create_index(op.f('ix_auth_user_ips_registered_by'), 'auth_user_ips', ['registered_by'], unique=False)
