...
class TestMediaFileAPIView(BaseTestAPIView):
    ...
    def test_get_media_file_bad_token__fail(self):
        ...

    def test_get_media_file_not_found__fail(self):
        ...

    def test_get_media_file_unknown_user_ip__fail(self):
        ...

    def test_get_media_file_user_ip_rss_registered__fail(self):
        ...


class TestRSSFileAPIView(BaseTestAPIView):
    def test_get_rss_register_user_ip__ok(self):
        ...


    def test_get_rss_rss_already_regestered__ok(self):
        ...
