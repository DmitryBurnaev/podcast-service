...
class TestRSSFileAPIView(BaseTestAPIView):
    url = "/r/{token}/"
    user_ip = '172.17.0.2'
    temp_link = f"https://s3.storage/tmp.link"
    ...
    def test_get_rss__register_user_ip__ok(self, client, rss_file, user, mocked_s3, method, status_code, headers):
    ...
    def test_get_rss__user_ip_already_registered_by__ok(self):
        raise AssertionError

    def test_get_not_rss__fail(self):
        raise AssertionError