...
async def download_audio(
    ...
    :param logger: logger instance (can be used for logging in-other-process logic with logger)
    ...
    params = {
        ...
        "progress_hooks": [partial(download_process_hook, logger=(logger or logger))],
        "noprogress": True,
    }
    if cookie:
