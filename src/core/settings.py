...
MAX_UPLOAD_AUDIO_FILESIZE = config(
    "MAX_UPLOAD_AUDIO_FILESIZE", default=(1024 * 1024 * 512)
)  # 512MB
MAX_UPLOAD_IMAGE_FILESIZE = config("MAX_UPLOAD_IMAGE_FILESIZE", default=(1024 * 1024 * 10))  # 10MB
