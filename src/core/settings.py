...
DEFAULT_PAGINATION_LIMIT = config("DEFAULT_PAGINATION_LIMIT", default=20, cast=int)
...
MAX_UPLOAD_AUDIO_FILESIZE = config("MAX_UPLOAD_AUDIO_FILESIZE", default=(1024 * 1024 * 512))  # 512M
MAX_UPLOAD_IMAGE_FILESIZE = config("MAX_UPLOAD_IMAGE_FILESIZE", default=(1024 * 1024 * 10))  # 10M
...
EPISODE_CHAPTERS_TITLE_LENGTH = config("EPISODE_CHAPTERS_TITLE_LENGTH", cast=int, default=65)
